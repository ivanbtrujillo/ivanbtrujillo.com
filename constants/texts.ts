...
Siendo honesto, esos estudios me han servido de poco y dónde realmente he encontrado la formación que me ha permitido avanzar en mi carrera profesional ha sido en libros, cursos online impartidos por referentes del sector y conociendo otros desarrolladores en eventos 👨‍💻. Durante este tiempo me enamoré de Javascript y de la posibilidad de crear apliaciones para cualquier plataforma utilizando el mismo lenguaje. Realmente me pasaba mis tardes programando, aprendiendo nuevas metodologías y conociendo otros desarrolladores. Haciendo sideprojects solo para aprender.
 
Esta formación adicional me permitió en 2016 empezar a trabajar como Frontend Developer en Blue Sky Technology 🤘, rol que un año despues se convirtió en Frontend Lead. Al principio empezamos a utilizar Angular 4 junto con Ionic, pero una vez fuí el lead empezamos a mover todo a React y a React native. Estaba contento con mi trabajo, pero quería seguir creciendo y aprendiendo. Durante todo este tiempo tampoco paré de aprender durante mi tiempo libre 🤓.
 
A finales de 2018 me uní a Expero como Intermediate Frontend Developer 🚀🇺🇸. Expero es una empresa Americana ubicada en Houston / Austin (Texas) que realiza desarrollos para importantes empresas de USA. Unirme a ellos me ha permitido ser mucho mas independiente, aprender de grandes compañeros y miembros de expero y continuar creciendo.
